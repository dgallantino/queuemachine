...
urlpatterns = [
    ...
    path('machine/booking-list/<uuid:pk>/print/',views.PrintBookingTicket.as_view(), name='booking_print_url'),
    ...
    path('manager/services/',views.ServiceLookupView.as_view(),name='service_lookup_url'),
