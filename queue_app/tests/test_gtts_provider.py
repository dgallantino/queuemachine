...
def test_synthesize_retries_then_writes_wav():
...
def test_fetch_mp3_uses_gtts():
    ...
    assert isinstance(fake_tts.write_to_fp.call_args[0][0], BytesIO)
    assert result == fake_tts.write_to_fp.call_args[0][0].getvalue()
